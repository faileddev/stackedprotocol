    ...
    : "0.0"} WETH
        ...
        <div style={{
                        ...
                        <div style={{
                            ...
                            ~ ${borrowingPower 
                                ...
                                <span style={{
                                    ...
                                    marginLeft: "5px"}}
                                    >
                                        {borrowLimitInAsset ? `${truncate(toEther(BigInt(Number(borrowLimitInAsset)) * BigInt(1)),2)} WETH` : "N/A"}
                                </span>
                             </p>
                        ...
                        <div style={{
                            ...
                            {truncate(toEther(incurredInterest!),4) } WETH
