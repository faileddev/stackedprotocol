                                    ...
                                    <div className="box">
                                        <p style={{fontSize: "10px"}}>
                                           Wallet Balance:
                                              ...
                                              <h3>{formatNumber(truncate(toEther(WETHBalance!),4)) }<span style={{fontSize: "10px"}}> WETH</span>
                                            </h3>
                                            <p style={{
                                                            fontSize: "10px",
                                                            color: "GrayText",
                                                           }}>
                                                ~ ${Number(WETHBalanceInUSD).toLocaleString()}
                                             </p>
                                    </div>
