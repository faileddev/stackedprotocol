...
useEffect(() => {
  if (totalDeposits && totalBorrows && apr) {
    ...
    const [borrowLimitInAsset, setBorrowLimitInAsset] = useState<string>("Calculating...");
                        ...
                        <div style={{
                            ...
                            ~ ${borrowingPower 
                                ...
                                <span style={{
                                    ...
                                    marginLeft: "5px"}}
                                    >
                                       {borrowLimitInAsset !== "N/A" && !isNaN(Number(borrowLimitInAsset))
    ? `${toEther(BigInt(Number(borrowLimitInAsset)) * BigInt(1))} DAI`
    : "N/A"}
                                </span>
                             </p>
